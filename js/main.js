...
// BUTTON For WHAT WORKS FOR HEALTH
    ...
    function placeColorData(array) {
      ...
      for (var i=0;i<array.length;i++) {
        if ((housingPick==array[i].housingPick || housingPick==array[i].housingPick2 || housingPick==array[i].housingPick3) && (colorPick==array[i].colorPick || colorPick==array[i].colorPick2)) {
...
//--------------------------------------
  ...
  },
  {
    ...
    "description": "Support the federal-state partnership that pays participating land owners an annual rental rate for removing environmentally sensitive land from production and introducing conservation practices on the land",
    "rating": "Some Evidence",
    "url": "http://www.countyhealthrankings.org/policies/conservation-reserve-enhancement-program-crep",
    "housingPick": "",
    "housingPick2": "",
    "housingPick3": "rural",
    "colorPick": "blue",
  ...
  {
    "title": "Conservation tillage practices",
    "description": "Encourage methods of soil cultivation that keep at least one-third of cultivated soil covered with the previous year’s crop residue (e.g., mulch till, ridge till, strip till, or no-till)",
    "rating": "Scientifically Supported",
    "url": "http://www.countyhealthrankings.org/policies/conservation-tillage-practices",
    "housingPick": "",
    "housingPick2": "",
    "housingPick3": "rural",
    "colorPick": "blue",
    ...
    "description": "Support site-specific plans for crop production that match nutrient applications to crop needs, typically with agricultural best management practices",
    "rating": "Scientifically Supported",
    "url": "http://www.countyhealthrankings.org/policies/nutrient-management-plans",
    "housingPick": "",
    "housingPick2": "",
    "housingPick3": "rural",
    "colorPick": "blue",
  ...
  {
    "title": "Rural transportation systems",
    "description": "Establish transportation services for areas with low population densities, using publicly funded buses and vans on a set schedule, dial-a-ride transit, volunteer ridesharing, etc.",
    "rating": "Expert Opinion",
    "url": "http://www.countyhealthrankings.org/policies/rural-transportation-systems",
    "housingPick": "",
    "housingPick2": "",
    "housingPick3": "rural",
    "colorPick": "green",
